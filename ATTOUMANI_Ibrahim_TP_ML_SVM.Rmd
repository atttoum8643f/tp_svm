...
% Bas de page
\includegraphics[width=0.25\linewidth]{vis/ssd.png}\\[0.3cm]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{vis/classif_40test_60train.png}
    \caption{SVM linéaire avec 40\% des données réservées au test}
    \label{fig:svm_iris_40test_60train}
\end{figure}


## \textcolor{blue}{2.1. SVM polynomial : discrimination entre les classes 1 et 2 d’Iris}
